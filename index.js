...
var country_data_acco = [
  // {name:"Total overnight accommodation", value:country_values['2019']['Type']["TOTovernightaccommodation"]['GuestTot']},
  {name:"Hotel&youth hostel", value:country_values['2019']['Type']["Hotelboardinghouseyouthhostel"]['GuestTot']},
  // {name:"Total leisure accommodation", value:country_values['2019']['Type']["TOTLeisureaccommodation"]['GuestTot']},
  {name:"Campsite", value:country_values['2019']['Type']["Campsite"]['GuestTot']},
  {name:"Holiday park", value:country_values['2019']['Type']["Holidaypark"]['GuestTot']},
  {name:"Group accommodation", value:country_values['2019']['Type']["Groupaccommodation"]['GuestTot']}
];

// console.log(country_values['2019']['Country']["NL"]["GuestTot"]);

var country_data_vis = [
  // {name:"the Netherlands", value:country_values['2019']['Country']["NL"]["GuestTot"]},
 {name:"Germany", value:country_values['2019']['Country']["Germany"]["GuestTot"]},
 {name:"Belgium", value:country_values['2019']['Country']["Belgium"]["GuestTot"]},
 {name:"United Kingdom", value:country_values['2019']['Country']["UnitedKingdom"]["GuestTot"]},
 {name:"France", value:country_values['2019']['Country']["France"]["GuestTot"]},
 {name:"Switzerland and Liechtenstein", value:country_values['2019']['Country']["SwitzerlandandLiechtenstein"]["GuestTot"]},
 {name:"Italy", value:country_values['2019']['Country']["Italy"]["GuestTot"]},
 {name:"Spain", value:country_values['2019']['Country']["Spain"]["GuestTot"]},
 {name:"Denmark", value:country_values['2019']['Country']["Denmark"]["GuestTot"]},
 {name:"Sweden", value:country_values['2019']['Country']["Sweden"]["GuestTot"]},
 {name:"Other countries Euro zone", value:country_values['2019']['Country']["OtherEurozone"]["GuestTot"]},
 {name:"Other European countries", value:country_values['2019']['Country']["OtherEUcountries"]["GuestTot"]},
 {name:"America", value:country_values['2019']['Country']["America"]["GuestTot"]},
 {name:"Asia", value:country_values['2019']['Country']["Asia"]["GuestTot"]},
 {name:"Australia and Oceania", value:country_values['2019']['Country']["AustraliaandOceania"]["GuestTot"]},
 {name:"Africa", value:country_values['2019']['Country']["Africa"]["GuestTot"]}
];
...
barHeight2 = Math.min(screenWidth, 325) - barMargin2.top - barMargin2.bottom;
// =================
// Set up the Map:
// =================
...
d3.json("nldataset.json", function(error, nl) {
...
var barChart =	chart.selectAll(".bar")
 ...
 // Create a band scale that returns the width of each bar - https://github.com/d3/d3-scale/blob/master/README.md#band_bandwidth
      ...
      chart2.append("text")
      .attr("text-anchor", "middle")  // this makes it easy to centre the text as the transform is applied to the anchor
      .attr("transform", "translate("+ (barWidth2/2) +","+(barHeight2-(barMargin2.bottom - 200))+")")  // centre below axis
...
function handleProviMouseOut(d) {
  ...
  // Update textbox on mouseout
   ...
   totalPopulation.text("Total Guests: 107180");
